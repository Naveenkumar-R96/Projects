 ...
 setItem(update)
  ...
  return (
    ...
    <table className="shadow-lg bg-white  table-auto rounded mt-4 w-full border-collapse border border-slate-500">
      <tr className="">
        <th className="bg-zinc-100 text-center border border-slate-500  px-4 py-3 w-20px max-sm:hidden">Number</th>
        ...
        <th className="bg-zinc-100 text-center border border-slate-500  px-4 py-3 max-sm:hidden">End Time</th>
        <th className="bg-zinc-100 text-center border border-slate-500  px-4 py-3">Status</th>
      </tr>
    { items.length > 0 ? (items.map((item, ind) => (
        <tr key={ind}>
          <td className="px-4  border text-center border-slate-500 py-4 max-sm:hidden">{ind+1}</td>
          <td className="px-4  border text-center border-slate-500 py-4">{item.product}</td>
          <td className="px-4  border text-center border-slate-500 py-4 max-sm:hidden">{item.price}</td>
